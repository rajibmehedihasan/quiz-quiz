...
function ProgressBar() {
    return (
        <div className="w-[calc(100vw-100px) fixed left-0 right-0 bottom-5 my-0 mx-auto grid grid-cols-[50px_1fr_auto] items-center justify-between gap-5 rounded-lg border border-[#e5e5e5] bg-white">
